...
PYTHONPATH="$PWD"  \
    ...
    Global.checkpoints="/home/maxim/code/SubProject/PaddleOCR_output/PP-OCRv5_mobile_det_anime/latest/latest" \
    Global.epoch_num=4
...
PYTHONPATH="$PWD"  \
    ...
    Global.checkpoints="/home/maxim/code/SubProject/PaddleOCR_output/french_PP-OCRv5_mobile_rec/best_accuracy/best_accuracy"


# EVAL
#Det
python3 tools/eval.py -c ../PaddleOCRAnime/fine_tunning_paddleOCR/PP-OCRv5_server_det_anime.yml  \
    -o Global.pretrained_model=/home/maxim/code/SubProject/PaddleOCR_output/PP-OCRv5_server_det_anime/latest/latest   \
    Eval.dataset.data_dir=../PaddleOCRAnime/dataset     Eval.dataset.label_file_list='[../PaddleOCRAnime/dataset/detTest.txt]'

# Rec
python3 tools/eval.py -c ../PaddleOCRAnime/fine_tunning_paddleOCR/french_PP-OCRv5_mobile_rec.yml -o \
    Global.pretrained_model=/home/maxim/code/SubProject/PaddleOCR_output/french_PP-OCRv5_mobile_rec/latest/latest
